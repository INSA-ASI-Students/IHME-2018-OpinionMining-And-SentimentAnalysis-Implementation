...
\subsubsection{POC - Traitement des données}
...
\subsubsection{POC - Test de méthodes de classification}
...
\subsubsection{POC - Test de paramètres de la méthode SVM}
...
\subsubsection{Implémentation d'une SVM}
