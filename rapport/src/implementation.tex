...
\begin{table}[h!]
	...
	\begin{tabular}{|l|l|l|l|l|l|l|}
		\hline
		\textbf{lr} & \textbf{$\beta_1$} & \textbf{$\beta_2$} & \textbf{decay} & \textbf{epochs} & \textbf{batch size} & \textbf{embedding vector} \\
		 & & & & & & \textbf{length} \\
		\hline
		0.01 & 0.9 & 0.9 & 0.01 & 10 & 64 & 32 \\
		\hline
	\end{tabular}
...
\par % Recherche des meilleurs paramètres
